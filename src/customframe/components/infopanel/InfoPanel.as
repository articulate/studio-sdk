package customframe.components.infopanel
{
	...
	/**
	 * This is the logic for the InfoPanel symbol in the library (/components/infopanel/InfoPanel.)
	 *
	...
	{	
		...
		public function ShowVideo(nWidth:int, nHeight:int):Sprite 
		{
			...
			if(m_spVideo == null || nAdjustedWidth != m_spVideo.width || nAdjustedHeight != m_spVideo.height)
			{
				...
				if (m_strFileName ==  "" && nameField.text ==  "" && titleField.text ==  "" && m_strEmail == "" && m_bBio == false)
				{
